...
var map = {
	...
	"./music-recordings/music-recordings.module": [
		...
		"default~music-recordings-music-recordings-module~music-releases-music-releases-module",
		"music-recordings-music-recordings-module"
	],
...
/* harmony import */ var _pages_assets_page_assets_page_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./pages/assets-page/assets-page.component */ "./src/app/pages/assets-page/assets-page.component.ts");
/* harmony import */ var _ng_dynamic_forms_core__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! @ng-dynamic-forms/core */ "./node_modules/@ng-dynamic-forms/core/fesm5/core.js");
/* harmony import */ var _ng_dynamic_forms_ui_material__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! @ng-dynamic-forms/ui-material */ "./node_modules/@ng-dynamic-forms/ui-material/fesm5/ui-material.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _pages_assets_page_assets_page_component__WEBPACK_IMPORTED_MODULE_47__["AssetsPageComponent"],
            ],
            imports: [
                ...
                _ng_dynamic_forms_core__WEBPACK_IMPORTED_MODULE_48__["DynamicFormsCoreModule"],
                _ng_dynamic_forms_ui_material__WEBPACK_IMPORTED_MODULE_49__["DynamicFormsMaterialUIModule"]
            ],
            entryComponents: [
                _dialogs_add_doc_dialog_add_doc_dialog_component__WEBPACK_IMPORTED_MODULE_30__["AddDocDialogComponent"],
                _dialogs_confirm_app_reset_dialog_confirm_app_reset_dialog_component__WEBPACK_IMPORTED_MODULE_20__["ConfirmAppResetDialogComponent"],
...
module.exports = "<mat-sidenav-container [hasBackdrop]=\"true\" class=\"app-container\" (backdropClick)=\"sidenav.close()\">\r\n  <mat-sidenav #sidenav mode=\"over\" (keydown.escape)=\"sidenav.close()\">\r\n    <mat-nav-list>\r\n      <mat-list-item *ngFor=\"let link of links\" (click)=\"gotoPage(link.href, sidenav)\">\r\n        <mat-icon mat-list-icon>{{ link.icon }}</mat-icon>\r\n        <a matLine>{{ link.title }}</a>\r\n      </mat-list-item>\r\n\r\n      <mat-list-item >\r\n       \r\n          <a matLine>Files</a>\r\n        </mat-list-item>\r\n\r\n\r\n\r\n\r\n    </mat-nav-list>\r\n  </mat-sidenav>\r\n\r\n  <mat-sidenav-content>\r\n\r\n    <mat-toolbar>\r\n      <button mat-icon-button (click)=\"sidenav.open()\">\r\n        <mat-icon>menu</mat-icon>\r\n      </button>\r\n\r\n      <span>{{ pageTitle$ | async }}</span>\r\n      <span class=\"spacer\"></span>\r\n\r\n\r\n      <button mat-icon-button (click)=\"gotoPage('/files', sidenav)\" >Files</button>    <span class=\"spacer\"></span>\r\n      <button mat-icon-button (click)=\"gotoPage('/recordings', sidenav)\" >Recordings</button>    <span class=\"spacer\"></span>\r\n      <button mat-icon-button (click)=\"gotoPage('/releases', sidenav)\" >Releases</button>    <span class=\"spacer\"></span>\r\n      <button mat-icon-button (click)=\"gotoPage('/works', sidenav)\" >Works</button>    <span class=\"spacer\"></span>\r\n      <button mat-icon-button (click)=\"gotoPage('/claims', sidenav)\" >Claims</button>    <span class=\"spacer\"></span>\r\n      <button mat-icon-button (click)=\"gotoPage('/settings', sidenav)\" >Settings</button>\r\n      <span class=\"spacer\"></span>\r\n\r\n\r\n\r\n\r\n\r\n      <button mat-icon-button (click)=\"gotoPage('/user', sidenav)\">\r\n        <mat-icon>person</mat-icon>\r\n      </button>\r\n    </mat-toolbar>\r\n\r\n  \r\n\r\n    <div class=\"page-content\">\r\n      <router-outlet></router-outlet>\r\n    </div>\r\n  </mat-sidenav-content>\r\n</mat-sidenav-container>\r\n"
...
module.exports = "<div class=\"row mb-2\">\r\n  <div class=\"col-3\"><img src=\"https://coverartarchive.org/release-group/8c2a0eae-1359-3577-9127-e3d862acc2a2/front-250.jpg\" style=\"width:100%; max-width:250px\" alt=\"David Bowie\"></div>\r\n  <div class=\"col-3\"><h2>David Bowie</h2></div>\r\n  <div class=\"col-12-sm col-3-xl\">\r\n  \r\n      <canvas [appDoughnutChart]=\"dummyData\"></canvas>\r\n\r\n  </div>\r\n\r\n  <div class=\"col-12-sm col-3-xl\">  \r\n    <canvas [appDoughnutChart]=\"dummyData2\"></canvas>\r\n</div>\r\n\r\n\r\n\r\n</div>\r\n\r\n\r\n\r\n\r\n<div class=\"table-responsive-lg\">\r\n\r\n  <table class=\"table table-striped table-hover table-sm small\">\r\n\r\n    <thead class=\"thead-dark\">\r\n      <tr>\r\n        <th class=\"year\">Year</th>\r\n        <th>Title</th>\r\n        <th class=\"artist\">Artist</th>\r\n        <th class=\"artist\">Right Ownership</th>\r\n        <th class=\"artist\">Licience</th>\r\n        <th class=\"rating\">Rating</th>\r\n        <th class=\"count\">Releases</th>\r\n      </tr>\r\n    </thead>\r\n\r\n    <tbody>\r\n      <tr>\r\n        <td class=\"c\">1967</td>\r\n        <td><a href=\"/release-group/5db40351-97ed-36a8-88e2-a21a2603cae1\"><bdi>David Bowie</bdi></a></td>\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n\r\n\r\n\r\n        <td>Warner Music</td>\r\n        <td>PRS</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:53%;\">2.65</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">10</td>\r\n      </tr>\r\n\r\n      <tr>\r\n        <td class=\"c\">1969</td>\r\n        <td><a href=\"/release-group/2e12918c-4973-3537-b9ab-e4723ae1ae1d\"><bdi>David Bowie</bdi></a> <span class=\"comment\">(<bdi>aka\r\n              “Man of Words / Man of Music” then “Space Oddity”</bdi>)</span></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Sony Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:74%;\">3.7</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">26</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1970</td>\r\n        <td><a href=\"/release-group/2536a41d-fde9-35d5-a6c6-cd4d94ffd916\"><bdi>The Man Who Sold the World</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:77%;\">3.85</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">21</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1971</td>\r\n        <td><a href=\"/release-group/743b0b2e-a23a-3182-950e-232f8cb0dfb7\"><bdi>Hunky Dory</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PRS India</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:88%;\">4.4</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">29</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1972</td>\r\n        <td><a href=\"/release-group/6c9ae3dd-32ad-472c-96be-69d0a3536261\"><bdi>The Rise and Fall of Ziggy Stardust and\r\n              the Spiders From Mars</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>MCPS</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:93%;\">4.65</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">44</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1973</td>\r\n        <td><a href=\"/release-group/50f8710f-3ae6-319b-85a7-afe783f13449\"><bdi>Aladdin Sane</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Sony Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:75%;\">3.75</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">23</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1973</td>\r\n        <td><a href=\"/release-group/8b7bd1c2-be07-3083-989a-714f219f1ff8\"><bdi>Pin Ups</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>MCPS</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:65%;\">3.25</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">16</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1974</td>\r\n        <td><a href=\"/release-group/0dc4835d-b21a-3612-bac6-ab1e782a1396\"><bdi>Diamond Dogs</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Sony Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:76%;\">3.8</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">23</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1975</td>\r\n        <td><a href=\"/release-group/8c2a0eae-1359-3577-9127-e3d862acc2a2\"><bdi>Young Americans</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>EMI Music</td>\r\n        <td>MCPS</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:66%;\">3.3</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">19</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1976</td>\r\n        <td><a href=\"/release-group/686cdbd1-b400-32d8-8cb8-9317a2e41a58\"><bdi>Station to Station</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:80%;\">4</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">25</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1977</td>\r\n        <td><a href=\"/release-group/f6a51281-56c4-3538-b915-65a9d4eb29b5\"><bdi>Low</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>EMI Music</td>\r\n        <td>PPL - PRS</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:87%;\">4.35</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">21</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1977</td>\r\n        <td><a href=\"/release-group/1f5ef8d3-10ca-30eb-b41e-85b16987d412\"><bdi>“Heroes”</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Universal Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:85%;\">4.25</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">20</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1978</td>\r\n        <td><a href=\"/release-group/002ea22f-70c6-3bba-830e-4e0af067993c\"><bdi>David Bowie Narrates Prokofiev’s Peter\r\n              and the Wolf</bdi></a></td>\r\n\r\n        <td><span class=\"name-variation\"><a href=\"/artist/0e43fe9d-c472-4b62-be9e-55f971a023e1\" title=\"Сергей Сергеевич Прокофьев – Prokofiev, Sergei Sergeyevich (Russian composer)\"><bdi>Prokofiev</bdi></a></span>;\r\n          <a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a>, <a\r\n            href=\"/artist/ff3fcff7-6c85-49d6-b954-ed7011a44e5a\" title=\"Philadelphia Orchestra, The\"><bdi>The\r\n              Philadelphia Orchestra</bdi></a>, <a href=\"/artist/c70e7c06-65e9-42bd-9059-4973fd20e127\" title=\"Ormandy, Eugene\"><bdi>Eugene\r\n              Ormandy</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:100%;\">5</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">6</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1979</td>\r\n        <td><a href=\"/release-group/d6dd84a2-1a62-378c-b6c9-86a8b2211634\"><bdi>Lodger</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>MCPS</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:76%;\">3.8</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">21</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1980</td>\r\n        <td><a href=\"/release-group/bb13cb45-254c-3a61-89a5-15d22a97e6d6\"><bdi>Scary Monsters… and Super Creeps</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:68%;\">3.4</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">18</td>\r\n      </tr>\r\n\r\n      <tr>\r\n        <td class=\"c\">1983</td>\r\n        <td><a href=\"/release-group/75c2bddf-1799-3eda-b6b3-a0cf5189d8ed\"><bdi>Let’s Dance</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:76%;\">3.8</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">24</td>\r\n      </tr>\r\n\r\n      <tr>\r\n        <td class=\"c\">1984</td>\r\n        <td><a href=\"/release-group/2d0af79a-cb12-32e3-9cae-21696b910d53\"><bdi>Tonight</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:64%;\">3.2</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">11</td>\r\n      </tr>\r\n\r\n      <tr>\r\n        <td class=\"c\">1987</td>\r\n        <td><a href=\"/release-group/28f8a0f8-0eb9-35a2-b6cd-d5be21e4428c\"><bdi>Never Let Me Down</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:65%;\">3.25</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">14</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1993</td>\r\n        <td><a href=\"/release-group/f5cc15ea-67a8-3c6b-9887-d45ae13a3156\"><bdi>Black Tie White Noise</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:53%;\">2.65</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">10</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1995</td>\r\n        <td><a href=\"/release-group/f05647bf-86a7-3e6e-872a-20eb465be0a5\"><bdi>1.Outside: The Nathan Adler Diaries: A\r\n              Hyper Cycle</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:78%;\">3.9</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">19</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1997</td>\r\n        <td><a href=\"/release-group/9a723e6e-2ede-371b-88bf-396cc362d77b\"><bdi>Earthling</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:72%;\">3.6</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">15</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">1999</td>\r\n        <td><a href=\"/release-group/e8a94ea7-8466-389e-830a-d356801ca68c\"><bdi>‘hours…’</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:60%;\">3</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">18</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">2002</td>\r\n        <td><a href=\"/release-group/fed49206-4869-307d-9bfa-08109424cb73\"><bdi>Heathen</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:76%;\">3.8</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">21</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">2003</td>\r\n        <td><a href=\"/release-group/0f9d1be4-e975-39e9-a5ee-867c87824f42\"><bdi>Reality</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:74%;\">3.7</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">17</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">2013</td>\r\n        <td><a href=\"/release-group/c20be759-d767-4a7c-96c5-7a870ebc3a30\"><bdi>The Next Day</bdi></a></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:72%;\">3.6</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">18</td>\r\n      </tr>\r\n\r\n      <tr>\r\n\r\n\r\n        <td class=\"c\">2016</td>\r\n        <td><a href=\"/release-group/1fd18f5b-9a92-41fd-a590-da6b5cc60d85\"><bdi>★</bdi></a> <span class=\"comment\">(<bdi>Blackstar</bdi>)</span></td>\r\n\r\n        <td><a href=\"/artist/5441c29d-3602-4898-b1a1-b77fa23b8e50\" title=\"Bowie, David\"><bdi>David Bowie</bdi></a></td>\r\n        <td>Warner Music</td>\r\n        <td>PPL</td> <td class=\"c\"><span class=\"inline-rating\">\r\n            <span class=\"star-rating\" tabindex=\"-1\"> <span class=\"current-rating\" style=\"width:83%;\">4.15</span> </span>\r\n          </span></td>\r\n        <td class=\"c\">14</td>\r\n      </tr>\r\n\r\n\r\n    </tbody>\r\n  </table>\r\n\r\n\r\n</div>"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2Fzc2V0cy1wYWdlL2Fzc2V0cy1wYWdlLmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = ".docs-viewport {\n  width: 100%;\n  height: 50vh; }\n\n.doc-item {\n  height: 50px;\n  max-height: 50px;\n  display: flex; }\n\n.doc-label {\n  flex: 1; }\n\n.doc-schema {\n  margin-right: 1em; }\n\n.add-content-button {\n  position: fixed;\n  bottom: 1em;\n  right: 1em; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/*!********************************!*\
  !*** ./src/app/pages/index.ts ***!
  \********************************/
/*! exports provided: AssetsPageComponent, DashboardPageComponent, ImportPageComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AdaptersService = /** @class */ (function () {
    ...
    AdaptersService.prototype.getAdapter = function (id) {
        return this.adapters$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(console.log));
    };
...
var SchemaRepositoryService = /** @class */ (function () {
    ...
    SchemaRepositoryService.prototype.init = function () {
        var _this = this;
        var enabledSchemas = ['Person', 'Photo', 'Project', 'Audio', 'Clip'];
