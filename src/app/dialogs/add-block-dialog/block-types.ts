export const BLOCK_TYPES = [
  ...
  },
  {
    ...
    label: 'Switch',
    description:
      'Conditionally run workflows based on evaluation of input value.',
    icon: 'fa-random',
    hasEditor: true,
    defaultConfig: {
      type: 'switch',
  ...
  },
  {
    ...
    label: 'Validator',
    description:
      'Data validation task. Only allows Flows to continue if the test passes.',
    icon: 'error',
    hasEditor: true,
    defaultConfig: {
      type: 'validator',
  ...
  },
  {
    ...
    label: 'Rename fields',
    description:
      'Use a field mapping to rename fields in an object or array of objects',
  ...
  },
  {
    ...
    label: 'Wallet',
    description:
      'Check information or perform actions with a wallet like Uphold, and make Cards with Payment Pointers',
