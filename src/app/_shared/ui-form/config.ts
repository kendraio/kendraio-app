...
export const config: ConfigOption = {
  validationMessages: [
    ...
    { name: 'max', message: maxValidationMessage },
    {
      ...
      message: passwordMatchValidationMessage,
    },
  ...
  types: [
    ...
    {
      name: 'money',
      component: types.FormlyFieldInputMoney,
      defaultOptions: {
    ...
    {
      name: 'percentage',
      component: KendraFieldInputPercentage,
      defaultOptions: {
        expressionProperties: {},
        defaultValue: 0,
        templateOptions: {
    ...
    {
      name: 'multiselect',
      component: types.KendraFieldSelect,
      defaultOptions: {
        templateOptions: {
          multiple: true,
    ...
    {
      name: 'k-timepicker',
      component: types.TimePickerComponent,
    },
    {
      name: 'kendraio-timepicker',
      component: types.TimePickerComponent,
    },
    {
      name: 'timepicker',
