...
import { trigger, style, transition, animate, keyframes, query, stagger, state, AnimationMetadata, } from '@angular/animations';
...
export class Animations {
    ...
    static pageAni: AnimationMetadata[] = [
            ...
            transition('* => *', [
                ...
                query(':leave', stagger('300ms', [
                    animate('.6s ease-out', keyframes([
                        ...
                        style({ opacity: .5, transform: 'translateY(15px)', offset: 0.3 }),
                        style({ opacity: 0, transform: 'translateY(-5%)', offset: 1.0 }),
                    ]))
                ]), { optional: true })
            ])
        ]),
        ...
        trigger('enterAnimate', [
            state('true',
                style({ opacity: 1, transform: 'translate(200px , 0)' })
            ),
            state('void',
        ...
        trigger('dropInOut', [
            ...
            transition('small => large', animate('1.5s cubic-bezier(0.215, 0.610, 0.355, 2.000)', keyframes([
                style({ opacity: 0, transform: 'translateY(-75%)', offset: 0 }),
                //  style({opacity: 1, transform: 'translateY(35px)',  offset: 0.5}),
                style({ opacity: 1, transform: 'translateY(0)', offset: 1.0 })
            ]))),

            transition('large => small', animate('1.5s cubic-bezier(0.215, 0.610, 0.355, 2.000)', keyframes([
                //   style({opacity: 0, transform: 'translateY(-75%)', offset: 0}),
                //  style({opacity: 1, transform: 'translateY(35px)',  offset: 0.5}),
