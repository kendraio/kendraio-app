...
export var comparisonOperators = {
  ...
  '!=': {
    'test': function (a: any, b: any):boolean { return a != b },
    'paramcount' : 2
  },
  '>': {
    'test' : function (a: any, b: any):boolean { return a > b },
  ...
  'typeof': {
    'test': function (a: any, b: any):boolean { return typeof a == b },
    'paramcount': 2,
  },
  // these are single value operators, b is ignored
  'null': {
    'test' : function (a: any, b: any):boolean { return a === null },
    'paramcount' : 1
  },
  'not null': {
    'test': function (a: any, b: any):boolean { return a !== null },
  ...
  'empty': {
    'test': function (a: any, b: any):boolean { return a == '' },
    'paramcount' : 1
  },
  'not empty' : {
    'test': function (a: any, b: any):boolean { return a != '' },
...
export class ComparisonComponent extends BaseBlockComponent {
  ...
  isValid(comparison:comparisonDefinition):boolean{
    ...
    if (comparison.operator in comparisonOperators) {
      ...
      if (comparisonOperators[comparison.operator].paramcount == 2) {
